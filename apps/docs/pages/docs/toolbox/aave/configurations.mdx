...
```ts twoslash
import { getCompleteReserveConfiguration } from "@aave-dao/toolbox";
import { getClient, ChainId } from "@aave-dao/toolbox";
...
- Numbers with tight bounds (like LTV ≤ 10000) are returned as `number`
