...
The `@aave-dao/toolbox` package provides a comprehensive collection of utilities for working with Ethereum, Aave, and other web3 protocols. It includes tools for mathematical operations, ecosystem integrations, protocol-specific helpers, and more.
...
### 🛡️ Seatbelt (Testing & Verification)
...
- **Browser**: `@aave-dao/toolbox` (excludes Node-specific features)
- **Node**: `@aave-dao/toolbox/node` (includes all features)
