...
The supported environment variables are documented in [this](https://github.com/aave-dao/toolkit/blob/main/packages/toolbox/src/ecosystem/rpcs.spec.ts#L54) test.
